...
%package license
Summary: license components for the perl-Async-MergePoint package.
Group: Default
...
cp %{_builddir}/Async-MergePoint-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Async-MergePoint/73509ad8bccb407824999613608fe7ba0f017e93 || :
if test -f Makefile.PL; then
...
%files dev
%defattr(-,root,root,-)
/usr/share/man/man3/Async::MergePoint.3
