...
Requires: perl-Async-MergePoint-man
...
%package man
Summary: man components for the perl-Async-MergePoint package.
Group: Default

%description man
man components for the perl-Async-MergePoint package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Async/MergePoint.pm
